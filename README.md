...
> [!IMPORTANT]
> This is **sample code** intended for educational and demonstration purposes. It is **not production-ready** and is provided as a reference implementation. Before any production use, conduct your own security review, harden the configuration (least-privilege IAM, logging, monitoring, key management, and input validation), and validate it against your organization's compliance requirements. Deploying this code will create AWS resources that may incur costs.
